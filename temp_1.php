...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <footer>
        <p>&copy; <?php echo PAGE_COPYRIGHT; ?></p>
      </footer>
    ...
    <script>
            var $table = $('#project-table'),
                    $button = $('#bt_update_project');
            $(function () {
                $button.click(function () {
                    var selectRow = $.map($table.bootstrapTable('getSelections'), function (row) {
//                        return row.id;
                        $('#input_project_name').val(row.project_name);
                        $('#select_project_area').val(row.project_aera);
                    });
                    $('#myModal').modal('show');
                });
            });
